    ...
    <div className="flex justify-center gap-4 my-4 flex-wrap">
      {showPersonaTool && (
        <button
          ...
          className="flex items-center gap-2 text-sm bg-fuchsia-900/20 text-fuchsia-200 px-4 py-2 border-2 border-fuchsia-700 hover:bg-fuchsia-900/30 transition-colors disabled:opacity-50 uppercase font-mono"
        >
