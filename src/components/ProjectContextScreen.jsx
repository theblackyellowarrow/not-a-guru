  ...
  return (
    <div className="bg-black text-gray-200 font-sans flex flex-col h-screen antialiased items-center justify-center p-4">
      <div className="w-full max-w-md text-center">
        <h1 className="text-3xl font-bold text-cyan-400 mb-2 uppercase font-mono">What&apos;s the context?</h1>
        ...
        <div className="space-y-4">
          {contexts.map(({ key, icon: Icon, label }) => (
            <button
              ...
              className="w-full flex items-center gap-4 p-4 bg-gray-900 border-2 border-gray-800 text-left hover:bg-cyan-900/20 hover:border-cyan-400 transition-all duration-200"
            >
