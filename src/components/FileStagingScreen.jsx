  ...
  return (
    <div className="view-enter bg-black text-gray-200 font-sans flex flex-col h-screen antialiased items-center justify-center p-4">
      ...
      <div className="w-full max-w-2xl">
        <h1 className="text-3xl font-bold text-center text-fuchsia-400 mb-2 uppercase font-mono">{title}</h1>
          ...
          {requiredFiles.map(({ key, label, compulsory }) => (
            <div key={key} className="flex items-center justify-between p-3 bg-black">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-gray-200 uppercase font-mono">
                    {label} {compulsory && <span className="text-fuchsia-400 font-bold">*</span>}
                  </span>
                  {stagedFiles[key] && (
              ...
              <button
                ...
                className="text-sm text-fuchsia-400 hover:text-fuchsia-300 font-semibold uppercase font-mono"
              >
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          <button
            ...
            disabled={!canSubmit}
            className="bg-fuchsia-600 text-black font-bold py-2 px-6 disabled:bg-gray-600 disabled:cursor-not-allowed hover:bg-fuchsia-500 transition-colors uppercase font-mono"
          >
